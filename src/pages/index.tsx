...
const data = {
  ...
  message: "Our amazing website is currently under construction and we can't wait for you to experience it! Please enter your email below for launch notification and/or beta testing instructions."
}
      ...
      <Billboard image="/img/laptop-1920.jpg" title="">
        <>
          ...
          <div className="row d-flex justify-content-evenly" style={{marginTop: '8rem'}}>
            <div className="col-lg-5 col-md-11 col-sm-12">
              <h1 
          ...
          <div className="row d-flex justify-content-evenly" style={{marginTop: '2rem'}}>
            <div className="col-lg-5 col-md-11 d-none d-sm-block">
